      ...
      <div className="col-md-12 col-lg-8 offset-2">
        ...
        <div className=" text-start">
          {props.orderItems?.map((item: any, index: number) => {
            return (<ThankyouPageItem key={index} {...item} />
            )
          })}
        </div>
        ...
        <div className="row text-start">
          <div className="col-md-6">
            ...
            <p className="fs-20 font-r text-color-1 mt-4">
              {props.authStatus == "AUTH_APPROVED" ? "RUPIFI (BNPL)" : "Cash On Delivery"}
            </p>
          </div>
          <div className="col-md-6">
        ...
        <div className="row text-start ">
          <div className="col-md-6 helpBar">
            ...
            <li className="mb-1">
              ...
              <a className="fs-20 font-r text-color-10" href="#">
            ...
            </li> */}<li style={(props?.orderDetails?.status === 'cancelled') ? { pointerEvents: 'none', } : {}}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={16}
                  height={16}
                ...
                {props?.orderDetails?.status === 'cancelled' ? <a className="fs-20 font-r text-color-10" >
                  Order cancelled
                </a> : <a className="fs-20 font-r text-color-10" onClick={() => { props?.cancelOrder(props?.orderDetails?.id) }}>
                  Cancel order
                </a>}
              </li>
            </ul>
